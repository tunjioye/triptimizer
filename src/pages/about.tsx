      ...
      <main className="container" role="document">
        <hgroup>
          ...
          <h3>
            ...
            most efficient routes for your journeys, taking into account either the shortest
            distance or the shortest time to reach multiple destinations.
          </h3>
        </hgroup>
        ...
        <p>
          Whether you are planning a road trip, a delivery route, or a series of errands,
          Triptimizer can handle it all. Simply input your list of addresses, specify your
          preferences for shortest distance or shortest time, and let Triptimizer do the rest.
          Within seconds, you will receive a well-organized itinerary that guides you from your
          starting point to each subsequent destination with maximum efficiency.
        </p>
        ...
        <p>
          ...
          takes the hassle out of planning and ensures that you always reach your destinations in
